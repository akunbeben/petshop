                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row justify-content-center">
                                        ...
                                        id="edit-penitipan"
                                        data-toggle="modal" 
                                        data-target="#editpenitipan"
                                        data-id="<?= $penitipan->id; ?>"
                                        data-nama_peliharaan="<?= $penitipan->nama_peliharaan; ?>"
                                        data-pemilik="<?= $penitipan->id_pemilik; ?>"
                                        data-catatan="<?= $penitipan->catatan; ?>"
                                        >
